...
# Description:
# Writing a program that generates all factors of a given number. 
# Also provide a mathematically summary of how different pairs of factors can be multiplied together to get the given number.
