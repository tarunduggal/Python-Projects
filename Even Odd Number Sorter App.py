...
# Project Description:
# Creating a program that sorts a list of comma separated numbers as either even or odd. 
# After sorting the numbers into two groups, the program will then sort each group numerically and display the results
